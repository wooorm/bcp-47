...
ERRORS[ERR_EXTENSION_TOO_LONG] = 'Too long extension, expected at most 8 characters';
ERRORS[ERR_TOO_MANY_SUBTAGS] = 'Too many extended language subtags, expected at most 3 subtags';
ERRORS[ERR_EMPTY_EXTENSION] = 'Empty extension, extensions must have at least 2 characters of content';
ERRORS[ERR_PRIVATE_USE_TOO_LONG] = 'Too long private-use area, expected at most 8 characters';
  ...
  if (index < MIN_ISO_639 || index > MAX_SUBTAG) {
    ...
    if (index > MAX_RESERVED) {
      ...
      while (
        ...
        result.extendedLanguageSubtags.push(sensitive.slice(index + 1, index + 4));
